...
//Pega o nome do serviço pelo diretório
const s = __dirname
const arr = s.split('\\');
console.log("🚀 ~ file: publish.js ~ line 24 ~ arr", s)
...
function buildNav(members) {
    let globalNav;
    let nav = `<h2><a href="index.html">CADTI - Serviço ${serviceName}</a></h2>`;
    const seen = {};
    const seenTutorials = {};
